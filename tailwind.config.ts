...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "custom-shadow":
          "0px 0px 27.993px 0px rgba(52, 224, 161, 0.18), 0px 0px 38.76px 0px rgba(52, 224, 161, 0.15), 0px 0px 53.115px 0px rgba(52, 224, 161, 0.14)",
      ...
      backgroundImage: {
        "custom-gradient":
          "linear-gradient(180deg, rgba(0, 0, 0, 0.80) 21.11%, rgba(0, 0, 0, 0.00) 100%)",
        "custom-gradient2":
          "linear-gradient(0deg, #000 -12.9%, rgba(0, 0, 0, 0) 100%)",
      },
      colors: {
