  ...
  return (
    <div className="font-poppins container mx-auto">
      ...
      <div className="text-center pt-8 px-4">
        ...
        <p className="text-white text-[1rem] font-bold md:px-20 lg:px-40">
      ...
      {/* Section with 3 divs */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 py-[3rem] px-4 md:px-8 lg:px-15">
        {/* First Box */}
