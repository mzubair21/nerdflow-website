...
const slides = [
  ...
  },
  {
    ...
    description:
      "The Driver Interface module serves as the dedicated platform for Wizz Logistics' drivers to efficiently manage their assigned trips. This feature empowers drivers with real-time access to trip details, routes, and cargo information, facilitating streamlined on-road operations.",
  },
  {
    image: slide8bg,
    heading: "Chat System",
    description:
      "The Chatting feature establishes a dynamic communication hub within Wizz Logistics' ERP system, enabling users to interact seamlessly. With a built-in chatting system, team members can exchange vital information, updates, and queries in real time, enhancing collaboration across the logistical network.",
  },
  {
    image: slide9bg,
    heading: "Order Processing",
    description:
      "The Order Processing module offers a streamlined solution for managing orders within Wizz Logistics' ERP system. This feature automates order creation, processing, and tracking, ensuring seamless order fulfillment and enhancing customer satisfaction.",
  },
  {
    image: slide10bg,
    heading: "Inventory Management",
    description:
      "The Inventory Management feature provides a comprehensive solution for overseeing stock levels, tracking inventory movement, and managing warehouse operations. This module empowers Wizz Logistics to optimize inventory control, reduce carrying costs, and enhance operational efficiency.",
  },
  {
    image: slide11bg,
    heading: "Shipment Tracking",
    description:
      "The Shipment Tracking module offers real-time visibility into shipment status, location, and delivery timelines. This feature enables Wizz Logistics to monitor shipments, track delivery progress, and provide clients with accurate updates, enhancing transparency and customer satisfaction.",
  },
]

const LitigationManagementSystemCaseStudy = () => {
  return (
        ...
        <div className="relative z-10 flex items-end h-[28rem] bg-custom-gradient2">
          <div className="container flex flex-col gap-4">
            <h1 className="text-white font-semibold text-3xl">
              <span className="text-teal">Litigation</span> Management System
            </h1>
            <p className="text-white text-lg">
              PHP, Laravel, MySQL, HTML5, CSS, Javascript, Bootstrap
            </p>
          </div>
        </div>
      </div>
...
export default LitigationManagementSystemCaseStudy
