        ...
        <div className="relative z-10 flex items-end h-[28rem] bg-custom-gradient2">
          <div className="container flex flex-col gap-4">
            <h1 className="text-white font-semibold text-3xl">
              <span className="text-teal">Ecommerce</span> Management System
            </h1>
            <p className="text-white text-lg">
              A feature-rich platform to handle product listings, order
              processing, and customer engagement for online stores.
            </p>
          </div>
        </div>
      </div>
...
export default DailyBazarCaseStudy
