...
const slides = [
  ...
  },
  {
    ...
    description:
      "The Order Booking module revolutionizes the logistics initiation process for Wizz Logistics. This feature provides a streamlined platform to effortlessly book orders, capturing essential details such as shipment type, delivery addresses, and vehicle specifications.",
  },
  {
    image: slide10bg,
    heading: "Order Tracking",
    description:
      "The Order Tracking module offers Wizz Logistics an essential tool for real-time visibility into the status of each shipment. This feature enables accurate tracking of orders throughout their journey, providing timely updates on location, estimated delivery times, and any potential disruptions.",
  },
  {
    image: slide11bg,
    heading: "Recruitment Management",
    description:
      "The Recruitment Management module empowers Wizz Logistics' administrative team to seamlessly handle talent acquisition. This feature allows administrators to add and manage job openings, which are then displayed on the company's informational website.",
  },
]
        ...
        <div className="relative z-10 flex items-end h-[28rem] bg-custom-gradient2">
          <div className="container flex flex-col gap-4">
            <h1 className="text-white font-semibold text-3xl">
              <span className="text-teal">Wizz</span> Logistics
            </h1>
