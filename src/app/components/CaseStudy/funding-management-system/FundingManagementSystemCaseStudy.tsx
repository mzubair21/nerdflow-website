...
const FundingManagementSystemCaseStudy = () => {
  return (
        ...
        <div className="relative z-10 flex items-end h-[28rem] bg-custom-gradient2">
          <div className="container flex flex-col gap-4">
            <h1 className="text-white font-semibold text-3xl">
              <span className="text-teal">Funding</span> Management System
            </h1>
            <p className="text-white text-lg">
              A tailored platform to oversee funding applications, approvals,
              and financial tracking seamlessly.
            </p>
          </div>
        </div>
      </div>
...
export default FundingManagementSystemCaseStudy
